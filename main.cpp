...
std::vector<Dataset> generate(unsigned R, int group, double x0, double y0, std::ofstream &file) {
...
int main() {
    ...
    std::vector<Dataset> setA = generate(RADIUS, 1, RADIUS * 1.5, RADIUS, ones);
    std::vector<Dataset> setB = generate(RADIUS, 0, -RADIUS * 1.5, RADIUS, zeros);
